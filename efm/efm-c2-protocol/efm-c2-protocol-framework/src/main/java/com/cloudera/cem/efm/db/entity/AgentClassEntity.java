...
public class AgentClassEntity extends AuditableEntity<String> {

    @Column(name = "DESCRIPTION")
    private String description;

    @ElementCollection
    @CollectionTable(name="AGENT_CLASS_MANIFEST", joinColumns=@JoinColumn(name="AGENT_CLASS_ID"))
    @Column(name="AGENT_MANIFEST_ID")
    private Set<String> agentManifests = new HashSet<>();
