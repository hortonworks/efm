...
@Entity
@Table(name = "AGENT")
public class AgentEntity extends AuditableEntity<String> {
    ...
    private String agentStatusContent;
    ...
    public String getAgentStatusContent() {
        return agentStatusContent;
    }

    public void setAgentStatusContent(String agentStatusContent) {
        this.agentStatusContent = agentStatusContent;
    }
}
