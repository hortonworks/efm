...
/**
 * Service that schedules the FlowRefresherRunnable according to the configured refresh interval.
 */
@Service
@ConditionalOnNiFiRegistry
public class FlowRefresher extends BackgroundTaskScheduler {

    @Autowired
    public FlowRefresher(final FlowRefresherTask flowRefresherTask,
                         final NifiRegistryProperties nifiRegistryProperties) {
        super(flowRefresherTask, nifiRegistryProperties.getFlowRefreshInterval());
    }
