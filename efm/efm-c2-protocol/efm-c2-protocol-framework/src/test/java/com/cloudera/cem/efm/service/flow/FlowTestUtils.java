...
public class FlowTestUtils {
    ...
    public static VersionedFlowSnapshot createSnapshot(final String bucketId, final String flowId, int version) {
    ...
    public static FlowMappingEntity createFlowMappingEntity(
            final String agentClassName,
            final FlowUri flowUri,
        ...
        flowEntity.setRegistryFlowVersion(flowVersion);
