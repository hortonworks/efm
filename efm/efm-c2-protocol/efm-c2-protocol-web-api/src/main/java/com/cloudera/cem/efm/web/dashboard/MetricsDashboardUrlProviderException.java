...
public class MetricsDashboardUrlProviderException extends RuntimeException {

    private static final long serialVersionUID = -5221934163168718993L;

    public MetricsDashboardUrlProviderException() {
        super();
    }

    public MetricsDashboardUrlProviderException(String message) {
        super(message);
    }

    public MetricsDashboardUrlProviderException(String message, Throwable cause) {
        super(message, cause);
    }

    public MetricsDashboardUrlProviderException(Throwable cause) {
        super(cause);
    }
