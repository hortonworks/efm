 ...
 */
package com.cloudera.cem.efm.annotation;
...
/**
 * Marker annotation for beans that should only be created when the C2 server
 * is configured with a NiFi Registry instance.
 */
@Target(ElementType.TYPE)
@Retention(RetentionPolicy.RUNTIME)
@ConditionalOnProperty(name = "efm.nifi.registry.enabled", havingValue = "false", matchIfMissing = true)
public @interface ConditionalOnNiFiRegistryDisabled {
}
