...
import static com.cloudera.cem.efm.db.C2DatabaseProperties.PREFIX;

@Component
@ConfigurationProperties(PREFIX)
public class C2DatabaseProperties {

    static final String PREFIX = "efm.db";
    static final String URL = PREFIX + ".url";
    static final String DRIVER = PREFIX + ".driverClass";
