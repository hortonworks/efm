...
public class DateConverterFactory {
    ...
    @Bean
    public static Converter<Date, Long> dateToLongConverter() {
        return new AbstractConverter<Date, Long>() {
            @Override
    ...
    @Bean
    public static Converter<Long, Date> longToDateConverter() {
        return new AbstractConverter<Long, Date>() {
            @Override
