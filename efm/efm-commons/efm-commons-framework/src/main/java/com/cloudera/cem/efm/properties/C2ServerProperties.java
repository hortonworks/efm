...
@ConfigurationProperties(
        prefix = "efm.server",
        ignoreUnknownFields = false  // help catch copy/paste mistakes of props from NiFi/Registry that are close but not exact, e.g. trustStorePassword and truststorePasswd
)
public class C2ServerProperties extends ServerProperties {}
