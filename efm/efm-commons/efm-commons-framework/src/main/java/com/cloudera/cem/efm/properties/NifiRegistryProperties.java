 ...
 */
package com.cloudera.cem.efm.properties;
...
@Component
@ConfigurationProperties("efm.nifi.registry")
public class NifiRegistryProperties {

    private static final Duration DEFAULT_REFRESH_INTERVAL = Duration.ofMinutes(1);

    private boolean enabled = false;
    private String url;
    private String bucketId;
    private String bucketName;
    private Duration flowRefreshInterval = DEFAULT_REFRESH_INTERVAL;
    ...
    public Duration getFlowRefreshInterval() {
        return flowRefreshInterval;
    }

    public void setFlowRefreshInterval(Duration flowRefreshInterval) {
        this.flowRefreshInterval = flowRefreshInterval;
    }
}
