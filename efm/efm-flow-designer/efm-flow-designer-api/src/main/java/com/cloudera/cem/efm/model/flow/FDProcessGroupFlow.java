...
/**
 * Specialized representation of a process group meant to be used when needing all of the components in their "FD"-form
 * which provides the revisions and uris (i.e. FDProcessor instead of VersionedProcessor, etc.).
 */
@ApiModel
public class FDProcessGroupFlow {
    ...
    @Valid
    @NotNull
    private FDProcessGroupFlowContent flowContent;
    ...
    @ApiModelProperty("The flow content of the process group")
    public FDProcessGroupFlowContent getFlowContent() {
        return flowContent;
    }

    public void setFlowContent(FDProcessGroupFlowContent flowContent) {
    ...
    public boolean equals(Object obj) {
        ...
        if (!(obj instanceof FDProcessGroupFlow)) {
            return false;
        }

        final FDProcessGroupFlow other = (FDProcessGroupFlow) obj;
