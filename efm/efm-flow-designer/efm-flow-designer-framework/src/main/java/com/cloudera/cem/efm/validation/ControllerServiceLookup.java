...
public interface ControllerServiceLookup {
    ControllerServiceDefinition lookupDefinition(String flowId, VersionedControllerService serviceConfiguration);

    FDControllerService lookupInstance(String flowId, String serviceId);
}
