...
public class TestExpressionLanguageUtil {

    private static final PropertyDescriptor DESCRIPTOR = new PropertyDescriptor();

    static {
        DESCRIPTOR.setExpressionLanguageScope(ExpressionLanguageScope.VARIABLE_REGISTRY);
    }
