...
@Configuration
public class C2FilterConfig {

    public static final int REQUEST_LOGGING_FILTER_ORDER = -2;
    public static final int FORWARDED_HEADER_FILTER_ORDER = -1;
    ...
    public FilterRegistrationBean forwardedHeaderFilter() {
        ...
        filter.setOrder(FORWARDED_HEADER_FILTER_ORDER);
        return filter;
    }
