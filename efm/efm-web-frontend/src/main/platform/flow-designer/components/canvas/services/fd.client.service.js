...
function Client(commonService) {
     ...
     * @returns deferred
     */
    this.init = function (clientIdentifier) {
     ...
     */
    this.isNewerRevision = function (currentData, proposedData) {
        if (commonService.isDefinedAndNotNull(currentData)) {
