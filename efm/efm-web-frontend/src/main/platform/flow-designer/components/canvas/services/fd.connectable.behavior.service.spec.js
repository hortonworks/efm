...
describe('Platform Flow Designer ConnectableBehavior', function () {
    var connectableBehavior;
    ...
    beforeEach(function () {
        ...
        connectableBehavior = ngCoreTesting.TestBed.get(ConnectableBehavior);
    });

    it('should exist', function () {
        //assertions
        expect(connectableBehavior).toBeDefined();
    });
});
