...
describe('Platform Flow Designer DeselectableBehavior', function () {
    var deselectableBehavior;
    ...
    beforeEach(function () {
        ...
        deselectableBehavior = ngCoreTesting.TestBed.get(DeselectableBehavior);
    });

    it('should exist', function () {
        //assertions
        expect(deselectableBehavior).toBeDefined();
    });
});
