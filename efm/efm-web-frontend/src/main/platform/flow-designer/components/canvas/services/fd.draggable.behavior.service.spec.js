...
describe('Platform Flow Designer DraggableBehavior', function () {
    ...
    beforeEach(function () {
        ...
        draggableBehavior = ngCoreTesting.TestBed.get(DraggableBehavior);
    });

    it('should exist', function () {
        //assertions
        expect(draggableBehavior).toBeDefined();
    });
});
