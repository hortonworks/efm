...
describe('Platform Flow Designer EditableBehavior', function () {
    var editableBehavior;
    ...
    beforeEach(function () {
        ...
        editableBehavior = ngCoreTesting.TestBed.get(EditableBehavior);
    });

    it('should create component', function () {
        //assertions
        expect(editableBehavior).toBeDefined();
    });
});
