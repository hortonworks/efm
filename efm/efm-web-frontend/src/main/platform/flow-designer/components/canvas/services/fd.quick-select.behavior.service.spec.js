...
describe('Platform Flow Designer QuickSelectBehavior', function () {
    var quickSelectBehavior;
    ...
    beforeEach(function () {
        ...
        quickSelectBehavior = ngCoreTesting.TestBed.get(QuickSelectBehavior);
    });

    it('should exist', function () {
        //assertions
        expect(quickSelectBehavior).toBeDefined();
    });
});
