...
describe('Platform Flow Designer Remote Process Group Manager', function () {
    var remoteProcessGroupManager;
    ...
    beforeEach(function () {
        ...
        remoteProcessGroupManager = ngCoreTesting.TestBed.get(RemoteProcessGroupManager);
    });

    it('should exist', function () {
        //assertions
        expect(remoteProcessGroupManager).toBeDefined();
    });
});
