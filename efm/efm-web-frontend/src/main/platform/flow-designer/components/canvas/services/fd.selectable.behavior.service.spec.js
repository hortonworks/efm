...
describe('Platform Flow Designer SelectableBehavior', function () {
    ...
    beforeEach(function () {
        ...
        selectableBehavior = ngCoreTesting.TestBed.get(SelectableBehavior);
    });

    it('should exist', function () {
        //assertions
        expect(selectableBehavior).toBeDefined();
    });
});
