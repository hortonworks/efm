...
describe('Platform Flow Designer Connection Configuration Component', function () {
    var connectionConfigurationComponent;
    var fixture;
    ...
    beforeEach(function () {
        ...
        fixture = ngCoreTesting.TestBed.createComponent(ConnectionConfigurationComponent);

        connectionConfigurationComponent = fixture.componentInstance;
        connectionConfigurationComponent.connectionEntity = {
            'revision': {
        ...
        connectionConfigurationComponent.sourceEntity = {
            'revision': {
                'clientId': '2543b847-0165-1000-c3ff-61d6959a4366',
                'version': 1,
                'lastModifier': 'anonymous'
        ...
        connectionConfigurationComponent.destinationEntity = {
            'revision': {
                'clientId': '2543b847-0165-1000-c3ff-61d6959a4366',
                'version': 1,
                'lastModifier': 'anonymous'
    ...
    it('should create component', function () {
        //assertions
        expect(connectionConfigurationComponent).toBeDefined();
    });
    ...
    it('should open the confirm dialog when cancel is called and the config has changed', function () {
        ...
        connectionConfigurationComponent.unchanged = false;
    ...
    it('should cancel if no changes have been made', function () {
        ...
        connectionConfigurationComponent.subject$.subscribe(function () {
            fail();
        }, function () {
