...
describe('Platform Flow Designer Move Connection Component', function () {
    var moveConnectionComponent;
    var fixture;
    ...
    beforeEach(function () {
        ...
        fixture = ngCoreTesting.TestBed.createComponent(MoveConnectionComponent);

        moveConnectionComponent = fixture.componentInstance;
        moveConnectionComponent.connectionEntity = {
            'revision': {
        ...
        moveConnectionComponent.sourceEntity = {
            'revision': {
                'clientId': '2543b847-0165-1000-c3ff-61d6959a4366',
                'version': 1,
                'lastModifier': 'anonymous'
        ...
        moveConnectionComponent.destinationEntity = {
            'revision': {
                'clientId': '2543b847-0165-1000-c3ff-61d6959a4366',
                'version': 1,
                'lastModifier': 'anonymous'
    ...
    it('should create component', function () {
        //assertions
        expect(MoveConnectionComponent).toBeDefined();
    });
});
