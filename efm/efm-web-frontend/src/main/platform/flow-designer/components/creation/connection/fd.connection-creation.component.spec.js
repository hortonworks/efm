...
describe('Platform Flow Designer Connection Creation Component', function () {
    var connectionCreationComponent;
    var fixture;
    ...
    beforeEach(function () {
        ...
        fixture = ngCoreTesting.TestBed.createComponent(ConnectionCreationComponent);

        connectionCreationComponent = fixture.componentInstance;

        connectionCreationComponent.sourceEntity = {
            'revision': {
        ...
        connectionCreationComponent.destinationEntity = {
            'revision': {
                'clientId': '2543b847-0165-1000-c3ff-61d6959a4366',
                'version': 1,
                'lastModifier': 'anonymous'
    ...
    it('should create component', function () {
        //assertions
        expect(connectionCreationComponent).toBeDefined();
    });
});
