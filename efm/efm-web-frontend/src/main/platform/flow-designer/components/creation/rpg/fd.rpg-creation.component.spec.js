...
describe('Platform Flow Designer RPG Creation Component', function () {
    var rpgCreationComponent;
    var fixture;
    ...
    beforeEach(function () {
        ...
        fixture = ngCoreTesting.TestBed.createComponent(RpgCreationComponent);

        rpgCreationComponent = fixture.componentInstance;
    ...
    it('should create component', function () {
        //assertions
        expect(rpgCreationComponent).toBeDefined();
    });
});
