...
describe('Platform Flow Designer Draggable Component', function () {
    ...
    beforeEach(function () {
        ...
        fixture = ngCoreTesting.TestBed.createComponent(DraggableComponent);

        draggableComponent = fixture.componentInstance;
