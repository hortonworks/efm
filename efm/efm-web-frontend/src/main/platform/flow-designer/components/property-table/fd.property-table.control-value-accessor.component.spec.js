...
describe('Platform Flow Designer Property Table Component', function () {
    var propertyTableComponent;
    var fixture;
    ...
    beforeEach(function () {
        ...
        fixture = ngCoreTesting.TestBed.createComponent(PropertyTableComponent);

        propertyTableComponent = fixture.componentInstance;
    ...
    it('should create component', function () {
        //assertions
        expect(propertyTableComponent).toBeDefined();
    });
});
