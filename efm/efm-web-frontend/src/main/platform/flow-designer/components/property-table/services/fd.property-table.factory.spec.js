...
describe('Platform Flow Designer PropertyTableFactory', function () {
    var propertyTable;
    ...
    beforeEach(function () {
        ...
        // get the PropertyTable from the root injector
        propertyTable = new (ngCoreTesting.TestBed.get('PropertyTable'))();
    });
