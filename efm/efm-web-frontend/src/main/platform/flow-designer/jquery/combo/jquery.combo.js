            ...
            return this.each(function () {
                ...
                if (isDefinedAndNotNull(options) &&
                    ...
                    combo.click(function (event) {
                        ...
                        var comboOptions = $('<div></div>').addClass('combo-options mat-menu-panel').css({
                            'position': 'absolute',
                            'left': (position.left + 1) + 'px',
                            'top': (position.top + Math.round(combo.outerHeight())) + 'px',
                        ...
                        $.each(comboConfigOptions.options, function (i, option) {
                            var optionText = $('<span class="mat-menu-item"></span>').attr('title', option.text).text(option.text);
                            ...
                            if (!isBlank(option.description)) {
                                $('<div class="fa fa-question-circle"></div>').appendTo(optionText).qtip({
                    ...
                    $('<div class="fa fa-caret-down"></div>').appendTo(combo);
