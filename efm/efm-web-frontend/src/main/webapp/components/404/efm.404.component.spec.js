...
describe('EFM 404 Component', function () {
    var efmNotFound;
    var fixture;
    ...
    beforeEach(function () {
        ...
        fixture = ngCoreTesting.TestBed.createComponent(EfmNotFound);
        efmNotFound = fixture.componentInstance;
    });

    it('should create component', function () {
        //assertions
        expect(efmNotFound).toBeDefined();
    });
});
