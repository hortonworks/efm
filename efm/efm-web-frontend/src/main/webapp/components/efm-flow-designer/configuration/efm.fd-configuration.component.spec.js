...
describe('EFM Flow Designer configuration Wrapper Component', function () {
    var efmFlowDesignerConfigurationWrapper;
    var fixture;
    var efmComponent;
    ...
    beforeEach(function () {
        ...
        fixture = ngCoreTesting.TestBed.createComponent(EfmFlowDesignerConfigurationWrapper);
        efmFlowDesignerConfigurationWrapper = fixture.componentInstance;
        ...
        efmService.sidenavHost.component = { unchanged: null };

        dialogService = ngCoreTesting.TestBed.get(DialogService);
    });

    it('should have a defined component and route back to the flow designer canvas component', ngCoreTesting.fakeAsync(function () {
        // Spy
        spyOn(efmService, 'routeToFlowDesignerCanvasComponent').and.callFake(function () {});
        spyOn(efmService.flowDesignerCanvasComponent, 'configure').and.callFake(function () {
        ...
        //assertions
        expect(efmFlowDesignerConfigurationWrapper).toBeDefined();
        expect(efmService.routeToFlowDesignerCanvasComponent).toHaveBeenCalled();
        expect(efmService.flowDesignerCanvasComponent.configure).toHaveBeenCalled();
    }));

    it('should fail to configure and route back to the flow designer', ngCoreTesting.fakeAsync(function () {
        // Spy
