...
describe('EFM Flow Designer service configuration Wrapper Component', function () {
    var efmFlowDesignerControllerServiceConfigurationWrapper;
    var fixture;
    var efmComponent;
    ...
    beforeEach(function () {
        ...
        fixture = ngCoreTesting.TestBed.createComponent(EfmFlowDesignerControllerServiceConfigurationWrapper);
        efmFlowDesignerControllerServiceConfigurationWrapper = fixture.componentInstance;
    ...
    it('should have a defined component and route back to the flow designer canvas component', ngCoreTesting.fakeAsync(function () {
        // Spy
        spyOn(efmService, 'routeToProcessGroupComponentListing').and.callFake(function () {});
        ...
        //assertions
        expect(efmFlowDesignerControllerServiceConfigurationWrapper).toBeDefined();
        expect(efmService.routeToProcessGroupComponentListing).toHaveBeenCalled();
