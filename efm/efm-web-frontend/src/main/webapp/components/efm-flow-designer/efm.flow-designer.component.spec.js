...
describe('EFM Flow Designer Component', function () {
    var efmFlowDesigner;
    var fixture;
    var efmComponent;
    var efmService;
    ...
    beforeEach(function () {
        ...
        fixture = ngCoreTesting.TestBed.createComponent(EfmFlowDesigner);
        efmFlowDesigner = fixture.componentInstance;
    ...
    it('should create component', function () {
        //assertions
        expect(efmFlowDesigner).toBeDefined();
        expect(efmService.flowDesignerCanvasComponent).toBeDefined();
        expect(efmService.componentListingHost).toBeDefined();
        expect(efmService.sidenav).toBeDefined();
        expect(efmService.sidenavHost).toBeDefined();
    });
});
