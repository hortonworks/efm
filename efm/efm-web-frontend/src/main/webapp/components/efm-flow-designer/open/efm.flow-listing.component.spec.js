...
describe('EFM Flow Listing', function () {
    var efmFlowListing;
    var fixture;
    ...
    beforeEach(function () {
        ...
        fixture = ngCoreTesting.TestBed.createComponent(EfmFlowListing);

        efmFlowListing = fixture.componentInstance;
    ...
    it('should create component', function () {
        //assertions
        expect(efmFlowListing).toBeDefined();
    });
});
