...
describe('EFM Open Flow Component', function () {
    var efmOpenFlow;
    var fixture;
    ...
    beforeEach(function () {
        ...
        fixture = ngCoreTesting.TestBed.createComponent(EfmOpenFlow);

        var efmFlowListing = (ngCoreTesting.TestBed.createComponent(EfmFlowListing)).componentInstance;
        efmOpenFlow = fixture.componentInstance;
        efmOpenFlow.efmFlowListing = efmFlowListing;
    ...
    it('should create component', function () {
        //assertions
        expect(efmOpenFlow).toBeDefined();
    });
});
