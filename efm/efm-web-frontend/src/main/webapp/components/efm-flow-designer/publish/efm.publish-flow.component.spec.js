...
describe('EFM Flow Designer Publish Flow Component', function () {
    var efmFlowDesignerPublishFlow;
    var fixture;
    ...
    beforeEach(function () {
        ...
        fixture = ngCoreTesting.TestBed.createComponent(EfmFlowDesignerPublishFlow);

        efmFlowDesignerPublishFlow = fixture.componentInstance;
    ...
    it('should create component', function () {
        //assertions
        expect(efmFlowDesignerPublishFlow).toBeDefined();
    });
});
