...
describe('EFM Flow Designer selection Wrapper Component', function () {
    var efmFlowDesignerSelectionWrapper;
    var fixture;
    var efmComponent;
    ...
    beforeEach(function () {
        ...
        fixture = ngCoreTesting.TestBed.createComponent(EfmFlowDesignerSelectionWrapper);
        efmFlowDesignerSelectionWrapper = fixture.componentInstance;
    ...
    it('should have a defined component, fail to select requested canvas component, and route back to the flow designer', ngCoreTesting.fakeAsync(function () {
        // Spy
        spyOn(efmService, 'routeToFlowDesigner').and.callFake(function () {});
        spyOn(efmService.flowDesignerCanvasComponent, 'select').and.callFake(function () {
        ...
        spyOn(efmService.flowDesignerCanvasComponent, 'deselectAll').and.callFake(function () {});
        ...
        //assertions
        expect(efmFlowDesignerSelectionWrapper).toBeDefined();
        expect(efmService.routeToFlowDesigner).toHaveBeenCalled();
        expect(efmService.flowDesignerCanvasComponent.select).toHaveBeenCalled();
    }));
});
