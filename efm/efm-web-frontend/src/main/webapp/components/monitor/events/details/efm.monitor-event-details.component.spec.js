...
describe('EFM monitor event details Component', function () {
    var efmMonitorEventDetails;
    var fixture;
    var efmApi;
    ...
    beforeEach(function () {
        ...
        fixture = ngCoreTesting.TestBed.createComponent(EfmMonitorEventDetails);
        efmMonitorEventDetails = fixture.componentInstance;
    ...
    it('should create component', function () {
        //assertions
        expect(efmMonitorEventDetails).toBeDefined();
    });

    it('should cancel', function () {
        efmMonitorEventDetails.onClose = function () {
        };
        // Spy
        spyOn(efmMonitorEventDetails, 'onClose').and.callFake(function () {
        });
        efmMonitorEventDetails.cancel();

        //assertions
        expect(efmMonitorEventDetails.onClose).toHaveBeenCalled();
    });

    it('should not get event detail', function () {

        efmMonitorEventDetails.event = {
            id: '222',
            links: {}
        };
        efmMonitorEventDetails.onChange();

        //assertions
        expect(efmMonitorEventDetails.eventDetail.id).toBe('222');
    });

    it('should get event detail', function () {
        // Spy
        spyOn(efmApi, 'getEventDetail').and.callFake(function () {
        ...
        //assertions
        expect(efmApi.getEventDetail).toHaveBeenCalledWith('http://localhost');
        expect(efmMonitorEventDetails.eventDetail.id).toBe('111');
    });

    it('should fail to get event detail', function () {
        // Spy
        spyOn(efmApi, 'getEventDetail').and.callFake(function () {
