...
describe('EFM Component', function () {
    var efm;
    var flowProvider;
    var fixture;
    ...
    beforeEach(function () {
        ...
        fixture = ngCoreTesting.TestBed.createComponent(Efm);
        fixture.detectChanges();
        efm = fixture.componentInstance;
    ...
    it('should close safely and route to the canvas component', function () {
        spyOn(efm.sidenav, 'close');
        spyOn(efm.efmService, 'routeToFlowDesignerCanvasComponent');

        efm.efmService.sidenavHost.component = {
            unchanged: false,
            getType: function () {
                return 'funnel'
            },
        ...
        expect(efm.efmService.routeToFlowDesignerCanvasComponent).toHaveBeenCalledWith('test', '12345', 'funnel');
    });

    it('should close safely and route to the process group listing', function () {
        spyOn(efm.sidenav, 'close');
        spyOn(efm.efmService, 'routeToProcessGroupComponentListing');
        ...
        expect(efm.efmService.routeToProcessGroupComponentListing).toHaveBeenCalledWith('test', '123456', false);
    });
});
