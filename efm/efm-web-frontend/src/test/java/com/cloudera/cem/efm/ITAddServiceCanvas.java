...
public class ITAddServiceCanvas {
    ...
    @Test
    public void testAddServiceCanvas() throws Exception {
        ...
        // select services from canvas
        WebElement servicesButton = driver.findElement(By.xpath("//*[@id=\"efm-flow-designer-app-container\"]/div/div[2]"));
