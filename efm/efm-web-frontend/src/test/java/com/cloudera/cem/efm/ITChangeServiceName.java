...
public class ITChangeServiceName {
    ...
    public void testChangeServiceName() throws Exception {
        ...
        // wait for service name field to be visible
        wait.until(ExpectedConditions.visibilityOfElementLocated(By.id("mat-input-0")));

        // place cursor in service name field
        WebElement serviceNameInput = driver.findElement(By.id("mat-input-0"));
        serviceNameInput.clear();

        // clear name field and enter ABC for name
        serviceNameInput.sendKeys("ABC");
