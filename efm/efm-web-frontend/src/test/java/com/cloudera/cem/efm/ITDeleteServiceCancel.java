...
public class ITDeleteServiceCancel {
    ...
    @Test
    public void testDeleteServiceCancel() throws Exception {
        ...
        // confirm existence of Cancel button
        wait.until(ExpectedConditions.visibilityOfElementLocated(By.cssSelector("div.cdk-overlay-pane button.mat-fds-regular")));

        // select Cancel button
        WebElement cancelButton = wait.until(ExpectedConditions.visibilityOfElementLocated(By.cssSelector("div.cdk-overlay-pane button.mat-fds-regular")));
    ...
    public void tearDown() throws Exception {
        ...
        // select trash icon for service
        WebElement deleteServiceButton2 = driver.findElement(By.className("fa-trash"));
        deleteServiceButton2.click();
